...
class Ui_Dialog(QtWidgets.QWidget):
    ...
    def on_mysignal(self, id):
        ...
        if id == 1:
            msg.setText(
                "Номер реального бита должен быть меньше количества лживых битов на шифр каждого бита!!!")
        elif id == 2:
...
"")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(510, 80, 530, 511))
